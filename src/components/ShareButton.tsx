  ...
  return (
    <div className="relative inline-block" ref={menuRef}>
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-bold text-slate-700 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 ${className}`}
      ...
      {isOpen && (
        <div className="absolute right-0 bottom-full mb-2 z-50 w-56 rounded-2xl border border-slate-200 bg-white p-2.5 shadow-2xl animate-in fade-in slide-in-from-bottom-2 duration-150 dark:border-slate-800 dark:bg-slate-900">
