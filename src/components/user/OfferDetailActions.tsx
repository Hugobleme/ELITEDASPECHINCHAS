    ...
    <div className="space-y-3 pt-2">
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 rounded-xl border border-orange-200 bg-orange-50 px-3 py-2.5 text-xs font-bold text-orange-600 hover:bg-orange-100 dark:border-orange-900/40 dark:bg-orange-950/30 dark:text-orange-400 dark:hover:bg-orange-950/60 transition-colors"
        >
      ...
      <div className="flex items-center justify-between gap-3 pt-1">
        ...
        <a
          ...
          className="inline-flex items-center gap-1 text-xs font-semibold text-slate-400 hover:text-orange-500 transition-colors"
        >
